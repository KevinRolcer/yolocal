...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-09-2025 a las 08:09:56
...
(4, 28, 'La Patona', 'Bar-Dedicado a la ofrecer la mejor calidad en platillos, mientras disfrutas de las mejores bebidas de la región', 'Enrique Segoviano #34', '2345678909', 'lapatona@gmail.com', 'dasdsa', 'dsadsa', 'dsadas', 'sii', 1, '2025-09-10 22:21:23', 0, '1', ''),
...
(6, 6, 'Promo Vainillosa', 'Todos los postres sabor vainilla 10% de descuento aplicando este cupon', 51, 0, 0, '2025-08-23', 0, 1),
...
(12, 4, 'Viernes de Cubetazo', '2x1 en productos seleccionados', 49, 0, 0, '2025-08-30', 1, 1);
...
--
ALTER TABLE `promociones`
  MODIFY `ID_Promocion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
