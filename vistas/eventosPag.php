            ...
            <div class="event-grid">
                ...
                <div class="event-card">
                    <div class="card-image-container">
                        <img src="https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=400&h=300&fit=crop" alt="Concierto de Rock en Vivo" class="card-image">
                        <div class="card-tag categoria-musica">Música</div>
                        <div class="card-price">$350 MXN</div>
                    </div>
                    <div class="card-content">
                        <h3>Concierto de Rock en Vivo</h3>
                        <p class="card-description">Una noche increíble con las mejores bandas de rock de la región</p>
                        <div class="card-details">
                            ...
                            <div class="detail-item">
                                ...
                                <span>Auditorio Nacional, Puebla</span>
                            </div>
                        </div>
                ...
                <div class="event-card">
                    <div class="card-image-container">
                        <img src="https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=400&h=300&fit=crop" alt="Festival Gastronómico 2025" class="card-image">
                        <div class="card-tag categoria-gastronomia">Gastronomía</div>
                        <div class="card-price">$200 MXN</div>
                    </div>
                    <div class="card-content">
                        <h3>Festival Gastronómico 2025</h3>
                        <p class="card-description">Degusta los mejores platillos de chefs locales e internacionales</p>
                        <div class="card-details">
                            <div class="detail-item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-blue"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>
                            ...
                            <div class="detail-item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-red"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                                <span>Parque Ecológico, Puebla</span>
                            </div>
                        </div>
                        <div class="card-actions">
                            <button class="btn btn-primary">Comprar Boletos</button>
                ...
                <div class="event-card">
                    <div class="card-image-container">
                          <img src="https://images.unsplash.com/photo-1531243269054-5ebf6f34081e?w=400&h=300&fit=crop" alt="Expo Arte Contemporáneo" class="card-image">
                        <div class="card-tag categoria-gastronomia">Gastronomía</div>
                        <div class="card-price">$200 MXN</div>
                    </div>
                    <div class="card-content">
                ...
                <div class="event-card">
                    <div class="card-image-container">
                          <img src="https://images.unsplash.com/photo-1503095396549-807759245b35?w=400&h=300&fit=crop" alt="Teatro: La Casa de Bernarda Alba" class="card-image">
                        <div class="card-tag categoria-gastronomia">Gastronomía</div>
                        <div class="card-price">$200 MXN</div>
                    </div>
                    <div class="card-content">
