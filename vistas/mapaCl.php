...
<a href="../controladores/controladorEvento.php" class="enlace" data-tooltip="Eventos">
    ...
    <div class="contenedor-rutas">
        ...
        <div class="panel-lateral" id="panelLateral">
            ...
            <div class="header-panel">
                <div class="usuario-info">
                    ...
                    <div class="usuario-avatar">
                        <img src="../assets/img/LogoYolocal.png" alt="YoLocal" style="width: 30px;">
                    </div>
                    <span class="usuario-nombre">YoLocal</span>
                ...
                <div class="buscador-panel">
                    ...
                    <input type="text" id="inputBuscador" placeholder="Buscar negocios...">
            ...
            <div class="filtros-panel">
                ...
                <button class="btn-filtros" id="btnMasFiltros">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="lista-negocios" id="listaNegocios">
            </div>
        ...
        <div class="contenedor-mapa">
            ...
            <button class="btn-toggle-panel" id="btnTogglePanel">
            ...
            <div class="info-card" id="infoCard" style="display: none;">
                <button class="btn-cerrar-card" id="btnCerrarCard">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <line x1="18" y1="6" x2="6" y2="18"/>
                        <line x1="6" y1="6" x2="18" y2="18"/>
                    </svg>
    ...
    <script src="../assets/js/pagina/rutasNegocios.js"></script>
