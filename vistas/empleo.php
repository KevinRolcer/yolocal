    ...
    <header class="encabezado">
        <nav class="navbar">
            ...
            <div class="menu" id="mainMenu">
                ...
                <a href="../vistas/empleo.html" class="enlace active" data-tooltip="Empleo">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <div class="principal">
        ...
        <div class="main-content">
            ...
            <div class="jobs-list">
                ...
                <div class="job-item active" onclick="selectJob(this, 'visual-designer')">
                    <div class="job-header">
                        <div class="company-logo" style="background: linear-gradient(45deg, #6366f1, #8b5cf6);">P</div>
                        <div class="job-info">
                            <h3>Auxiliar de cocina</h3>
                            <div class="company-name">Cafetería X</div>
                            <div class="job-description">Ubicación</div>
                        </div>
                    </div>
                    <div class="job-meta">
                        <span>
                ...
                <div class="job-item" onclick="selectJob(this, 'product-designer')">
                    <div class="job-header">
                        <div class="company-logo" style="background: linear-gradient(45deg, #6366f1, #8b5cf6);">P</div>
                        <div class="job-info">
                            <h3>Product Designer</h3>
                            <div class="company-name">UX/UI Designer • Design Thinking • Figma • 4+</div>
                            <div class="job-description">The Product Designer is responsible for articulating and conceptualizing our product vision and to shape our features from start to finish. You will not only be improving</div>
                        </div>
                    </div>
                    <div class="job-meta">
                        <span>
                ...
                <div class="job-item" onclick="selectJob(this, 'senior-interaction')">
                    <div class="job-header">
                        <div class="company-logo" style="background: linear-gradient(45deg, #ef4444, #f97316);">S</div>
                        <div class="job-info">
                            <h3>Senior Interaction Designer</h3>
                            <div class="company-name">UI Designer • Motion Graphic • After Effect • 3+</div>
                            <div class="job-description">The Senior Interaction Designer is responsible for certain phases of design projects assigned to be implemented into outputs such as design research reports.</div>
                        </div>
                    </div>
                    <div class="job-meta">
                        <span>
                ...
                <div class="job-item" onclick="selectJob(this, 'sistemas-practicante')">
                    <div class="job-header">
                        <div class="company-logo" style="background: linear-gradient(45deg, #10b981, #059669);">A</div>
                        <div class="job-info">
                            <h3>Practicante de Sistemas</h3>
                            <div class="company-name">Agencia Automotriz • Puebla, Puebla</div>
                            <div class="job-description">Agencia Automotriz solicita practicantes para el área de Sistemas, que cubran los siguientes requisitos: estar cursando los últimos semestres de la licenciatura.</div>
                        </div>
                    </div>
                    <div class="job-meta">
                        <span>
